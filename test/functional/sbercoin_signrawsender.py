...
class SbercoinSignRawSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Now send some SBER to both addresses (one contract will increase its balance and the other one will throw),
...
if __name__ == '__main__':
    SbercoinSignRawSenderTest().main()
