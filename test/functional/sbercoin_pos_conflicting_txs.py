...
"""
class SbercoinPOSConflictingStakingMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Allow the sbercoin.com staker some time to run (since we set a mocktime the time will not advance)
        time.sleep(80)
...
if __name__ == '__main__':
    SbercoinPOSConflictingStakingMempoolTxTest().main()