...
#include <qt/sbercoinversionchecker.h>
    ...
    m_network_style(networkStyle)
{
    ...
    sbercoinVersionChecker = new SbercoinVersionChecker(this);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sbercoin.com address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sbercoin.com addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sbercoin.com addresses"));
    ...
    openAction->setStatusTip(tr("Open a sbercoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Sbercoin.com command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    {
        // Check for updates
        if(_clientModel->getOptionsModel()->getCheckForUpdates() && sbercoinVersionChecker->newVersionAvailable())
        {
            QString link = QString("<a href=%1>%2</a>").arg(SBER_RELEASES, SBER_RELEASES);
            QString message(tr("New version of Sbercoin.com wallet is available on the Sbercoin.com source code repository: <br /> %1. <br />It is recommended to download it and update this application").arg(link));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Sbercoin.com network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
