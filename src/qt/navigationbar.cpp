...
public:
    explicit NavToolButton(QWidget * parent, bool subBar):
        ...
        m_iconCached(false)
    {
        m_colorEnabled = GetStringStyleValue("navtoolbutton/color-enabled", "#1a961e");
        m_colorPressed = GetStringStyleValue("navtoolbutton/color-pressed", "#e5f3fe5");
        m_colorHover = GetStringStyleValue("navtoolbutton/color-hover", "#ffffff");
        m_colorDisabled = GetStringStyleValue("navtoolbutton/color-disabled", "#ffffff");
