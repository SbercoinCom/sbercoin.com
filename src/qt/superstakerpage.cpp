...
void SuperStakerPage::on_removeSuperStaker(const QModelIndex &index)
{
    ...
    {
        QMessageBox msgBox (QMessageBox::Question, tr("Confirm super staker removal"), tr("The selected super staker will be removed from the list. Are you sure?"),
...
void SuperStakerPage::on_restoreSuperStakers()
{
    if(m_model)
    {
        ...
        {
            QMessageBox msgBox(QMessageBox::Question, tr("Confirm super stakers restoration"), tr("Are you sure you wish to restore your super stakers?"),
