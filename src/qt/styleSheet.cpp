...
class SbercoinStyle : public QProxyStyle
{
public:
    SbercoinStyle()
    {
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    SbercoinStyle* sbercoinStyle = new SbercoinStyle;
    sbercoinStyle->setBaseStyle(mainStyle);
    app->setStyle(sbercoinStyle);
...
{
    return QStringList() << "theme3";
}

QStringList StyleSheet::getSupportedThemesNames()
{
    return QStringList() << "Default theme";
}
