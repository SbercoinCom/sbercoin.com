...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SBER");
    case mBTC: return QString("mSBER");
    case uBTC: return QString::fromUtf8("μSBER");
    case SAT: return QString("Greph");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Sbercoins");
    case mBTC: return QString("Milli-Sbercoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Sbercoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case SAT: return QString("Greph (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
