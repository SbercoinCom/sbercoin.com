#ifndef SBERVERSIONCHECKER_H
#define SBERVERSIONCHECKER_H

#include <QObject>

#define SBER_RELEASES "https://github.com/SbercoinCom/sbercoin.com/releases"
...
class SbercoinVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit SbercoinVersionChecker(QObject *parent = 0);
    ~SbercoinVersionChecker();
