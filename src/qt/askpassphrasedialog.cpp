...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox msgBox (QMessageBox::Question, tr("Confirm wallet encryption"),
                  tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR SBERS</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
