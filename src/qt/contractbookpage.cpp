    ...
    model(0)
{
    ...
    if (!platformStyle->getImagesOnButtons()) {
        ...
        ui->deleteContractInfo->setIcon(platformStyle->MultiStatesIcon(":/icons/remove", PlatformStyle::PushButton));
...
void ContractBookPage::on_deleteContractInfo_clicked()
{
    ...
    if(!indexes.isEmpty())
    {
        ...
        QMessageBox msgBox (QMessageBox::Question, tr("Delete contact address"), message.arg(contractAddress),
