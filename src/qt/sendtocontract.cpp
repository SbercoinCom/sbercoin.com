    ...
    m_results(1)
{
    ...
    ui->labelAmount->setToolTip(tr("The amount in SBER to send. Default = 0."));
    ui->labelSenderAddress->setToolTip(tr("The Sbercoin.com address that will be used as sender."));
