...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " sbercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  sbercoin-tx [options] <hex-tx> [commands]  Update hex-encoded sbercoin transaction\n" +
            "or:     sbercoin-tx [options] -create [commands]   Create hex-encoded sbercoin transaction\n" +
            "\n";
