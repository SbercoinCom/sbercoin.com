...
public:
    ...
    bool IsProofOfWork() const // sbercoin
    {
...
public:
    ...
    SERIALIZE_METHODS(CDiskBlockIndex, obj)
    {
        ...
        READWRITE(obj.hashStateRoot); // sbercoin
        READWRITE(obj.hashUTXORoot); // sbercoin
        READWRITE(obj.nStakeModifier);
        READWRITE(obj.prevoutStake);
        READWRITE(obj.hashProof);
        READWRITE(obj.vchBlockSigDlgt); // sbercoin
    }
