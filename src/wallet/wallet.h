...
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 2;
//! -discardfee default
static const CAmount DEFAULT_DISCARD_FEE = 1;
//! -mintxfee default
...
private:
    ...
    void StakeSbercoins(bool fStake, CConnman* connman);
