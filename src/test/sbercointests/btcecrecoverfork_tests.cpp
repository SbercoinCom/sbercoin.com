...
//    initState();
    ...
    std::vector<SbercoinTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createSbercoinTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createSbercoinTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createSbercoinTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createSbercoinTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
