...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Sbercoin.com address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
UniValue getdgpinfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("maxblocksize", (uint64_t)sbercoinDGP.getBlockSize(::ChainActive().Height()));
    obj.pushKV("mingasprice", (uint64_t)sbercoinDGP.getMinGasPrice(::ChainActive().Height()));
    obj.pushKV("blockgaslimit", (uint64_t)sbercoinDGP.getBlockGasLimit(::ChainActive().Height()));
        ...
        RPCHelpMan{"getaddressdeltas",
            "\nReturns all changes for an address (requires addressindex to be enabled).\n",
            {
                {"Input params", RPCArg::Type::OBJ, RPCArg::Optional::NO, "Json object",
                    {
                        {"addresses", RPCArg::Type::ARR, RPCArg::Optional::NO, "The Sbercoin.com addresses",
                            {
                                {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "The Sbercoin.com address"},
                            }
                        },
            ...
            RPCExamples{
                HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}'")
        + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}") +
                HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"], \"start\": 5000, \"end\": 5500, \"chainInfo\": true}'")
        + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"], \"start\": 5000, \"end\": 5500, \"chainInfo\": true}")
            },
        }.Check(request);
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
            RPCHelpMan{"getaddressbalance",
                ...
                RPCExamples{
                    HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}")
                },
            }.Check(request);
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
            RPCHelpMan{"getaddressutxos",
                ...
                RPCExamples{
                    HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}") +
                    HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"], \"chainInfo\": true}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"], \"chainInfo\": true}")
                },
            }.Check(request);
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
            RPCHelpMan{"getaddressmempool",
                ...
                RPCExamples{
                    HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}")
                },
            }.Check(request);
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
            RPCHelpMan{"getaddresstxids",
                ...
                RPCExamples{
                    HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"]}") +
                    HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"], \"start\": 5000, \"end\": 5500}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\"], \"start\": 5000, \"end\": 5500}")
                },
            }.Check(request);
...
static UniValue createmultisig(const JSONRPCRequest& request)
{
            RPCHelpMan{"createmultisig",
                ...
                "It returns a json object with the address and redeemScript.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of keys which are Sbercoin.com addresses or hex-encoded public keys.",
                        {
                            {"key", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED, "Sbercoin.com address or hex-encoded public key"},
                        }},
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"SjWnDZxwLhrJDcp4Hisse8RfBo2jRDZY5Z\\\",\\\"S6sSauSf5pF2UkUwvKGq4qjNRzBZYqgEL5\\\"]\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"SjWnDZxwLhrJDcp4Hisse8RfBo2jRDZY5Z\\\",\\\"S6sSauSf5pF2UkUwvKGq4qjNRzBZYqgEL5\\\"]\"")
                },
            }.Check(request);
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Sbercoin.com address to use for the signature."},
            ...
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("verifymessage", "\"SD1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\", \"signature\", \"my message\"")
                },
            }.Check(request);
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "sbercoin-cli and the GUI. There is no server-side difference.",
                {},
