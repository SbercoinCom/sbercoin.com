...
const char * const BITCOIN_CONF_FILENAME = "sbercoin.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Sbercoin.com
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Sbercoin.com
    // Mac: ~/Library/Application Support/Sbercoin.com
    // Unix: ~/.sbercoin.com
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sbercoin.com";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Sbercoin.com";
#else
    // Unix
    return pathRet / ".sbercoin.com";
#endif
#endif
}
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Sbercoin.com Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Sbercoin.com Core Developers";
    }
