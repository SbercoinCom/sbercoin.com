#ifndef SBERDELEGATION_H
#define SBERDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The ISbercoinStaker class Delegation filter
 */
...
/**
 * @brief The SbercoinDelegation class Communicate with the sbercoin delegation contract
 */
class SbercoinDelegation {
    
public:
    /**
     * @brief SbercoinDelegation Constructor
     */
    SbercoinDelegation();

    /**
     * @brief ~SbercoinDelegation Destructor
     */
    virtual ~SbercoinDelegation();
...
private:
    SbercoinDelegation(const SbercoinDelegation&);
    SbercoinDelegation& operator=(const SbercoinDelegation&);
    SbercoinDelegationPriv* priv;
};
#endif
