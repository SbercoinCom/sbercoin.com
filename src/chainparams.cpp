...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // sbercoin
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // sbercoin
    return genesis;
}
...
{
    const char* pszTimestamp = "24/Sep/2020 Federal Reserve Bank reveals details of digital dollar research";
    const CScript genesisOutputScript = CScript() << ParseHex("0497ea4708b2124890934718c040bbb88a408f8b70dcbb3ab743d1f7c399f6ca513114b58f4fb2ae908f012bd925508a8f061dbc1ee78b01910a20d4ddf2f28a6a") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 2102400; // sbercoin halving every 2 years
        consensus.BIP16Exception = uint256S("0x0000a8b0ba85ea46d2a03e846d8170c9a88a32a562a3d2a739f485743784bb6b");
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x0000a8b0ba85ea46d2a03e846d8170c9a88a32a562a3d2a739f485743784bb6b");
        ...
        consensus.QIP9Height = 6000;
        consensus.SIP1Height = 17130;
        consensus.nOfflineStakeHeight = 5003;
        consensus.powLimit = uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.posLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.QIP9PosLimit = uint256S("0000000000005fffffffffffffffffffffffffffffffffffffffffffffffffff"); // The new POS-limit activated after QIP9
        consensus.nPowTargetTimespan = 4 * 60; // 16 minutes
        consensus.nPowTargetTimespanV2 = 4 * 60;
        ...
        consensus.nMinimumChainWork = uint256S("0x00"); // sbercoin

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00"); // 708000
        ...
        genesis = CreateGenesisBlock(1600948800, 6941, 0x1f00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000a8b0ba85ea46d2a03e846d8170c9a88a32a562a3d2a739f485743784bb6b"));
        assert(genesis.hashMerkleRoot == uint256S("0x2e4525c15fb59bca35adab223479a0537d5a5743dbbd9ef162751d0d87cbe152"));
        ...
        checkpointData = {
            {
                { 0, uint256S("0000a8b0ba85ea46d2a03e846d8170c9a88a32a562a3d2a739f485743784bb6b")},
                { 5001, uint256S("617b9f81402ea557b5bc95f0157bed48fa7891fa8190ce0c22781a88a66ec23d")},
                 { 16533, uint256S("77ab280853bba93070044e890d958ca13d710b55e5ab64224a3f45c5d19e13b5")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.nSubsidyHalvingInterval = 2102400; // sbercoin halving every 2 years
        consensus.BIP16Exception = uint256S("0x0000b55c823a29e46f6baa7a5e0fcb4f673fa55521d77b112a27efb336681113");
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x0000b55c823a29e46f6baa7a5e0fcb4f673fa55521d77b112a27efb336681113");
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00"); // 690000
        ...
        genesis = CreateGenesisBlock(1600948801, 36233, 0x1f00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000b55c823a29e46f6baa7a5e0fcb4f673fa55521d77b112a27efb336681113"));
        assert(genesis.hashMerkleRoot == uint256S("0x2e4525c15fb59bca35adab223479a0537d5a5743dbbd9ef162751d0d87cbe152"));
        ...
        checkpointData = {
            {
                {0, uint256S("0000b55c823a29e46f6baa7a5e0fcb4f673fa55521d77b112a27efb336681113")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.BIP16Exception = uint256S("0x0ce93aab7bab4982f2b2cf9b562b58c8e300a2cce32d89123a6401d35eaeb742");
        consensus.BIP34Height = 0; // BIP34 activated on regtest (Used in functional tests)
        consensus.BIP34Hash = uint256S("0x0ce93aab7bab4982f2b2cf9b562b58c8e300a2cce32d89123a6401d35eaeb742");
        ...
        genesis = CreateGenesisBlock(1600948801, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0ce93aab7bab4982f2b2cf9b562b58c8e300a2cce32d89123a6401d35eaeb742"));
        assert(genesis.hashMerkleRoot == uint256S("0x2e4525c15fb59bca35adab223479a0537d5a5743dbbd9ef162751d0d87cbe152"));
        ...
        checkpointData = {
            {
                {0, uint256S("0ce93aab7bab4982f2b2cf9b562b58c8e300a2cce32d89123a6401d35eaeb742")},
            }
        };
...
public:
    ...
    : CRegTestParams(args)
    {
        ...
        // SBER have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
...
{
    return dev::eth::Network::sbercoinMainNetwork;
}
...
{
    consensus.nSubsidyHalvingInterval = 2102400; // sbercoin halving every 4 years
    consensus.posLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
